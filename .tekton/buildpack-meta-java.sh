...
COMPILED_BUILDPACK="buildpack/java"
...
ssh $SSH_ARGS "$SSH_HOST" \
  "REPOSITORY_TO_FETCH=${REPOSITORY_TO_FETCH} BUILDER_IMAGE=$BUILDER_IMAGE PLATFORM=$PLATFORM IMAGE=$IMAGE GO_VERSION=$GO_VERSION PACK_CLI_VERSION=$PACK_CLI_VERSION BUILD_ARGS=$BUILD_ARGS" BUILD_DIR=$BUILD_DIR \
